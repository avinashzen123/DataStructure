...
public class TwoDimVectorIterator {
	private int[][] vector;
	private int inner = 0;
	private int outer = 0;

	public TwoDimVectorIterator(int[][] vector) {
		this.vector = vector;
	}
	...
	public static void main(String[] args) {
		TwoDimVectorIterator dVectorIterator = new TwoDimVectorIterator(new int[][] {{2, 3}, {4, 5},{6}, {}});
